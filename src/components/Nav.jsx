    ...
    return (
        <header className="h-[191px] xsm:h-[170px] m-0 p-0 w-screen flex items-center justify-around flex-row top-0">
            <div className="self-start h-full w-[200px] m-0 p-0 xsm:h-[5%] xsm:hidden sups:hidden xsm:flex sm:flex lg:flex xl:flex">
                <a href="https://omartl2005.github.io/Voxify"><img className="xsm:w-full cursor-pointer hover:-translate-y-2 transition-all duration-700" alt="Voxify Logo" src={ logo } style={{ margin: 0, padding: 0, height: '180px', width: '200px' }} /></a>
            </div>
            <div className="w-[15%] h-full self-end flex items-center justify-around flex-row xsm:w-full xsm:h-full sups:w-full xl:w-[20%] md:w-[20%]">
